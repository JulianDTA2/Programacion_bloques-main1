...
# --- Fix para ejecución sin consola en .exe ---
import sys, io
...
# comentado from six import iteritems
# Compat: evitar depender de 'six' solo por iteritems
try:
    from six import iteritems  # si está instalado, úsalo
except Exception:
    def iteritems(d):
        return d.items()  # fallback para Python 3
...
def index_redirect():
    """Redirige siempre al index real dentro de /ardublockly/."""
    return redirect('/ardublockly/index.html')


# --- ARCHIVOS ESTÁTICOS DE ARDUBLOCKLY ---
...
def static_docs_index():
    ...
    return redirect('/docs/Home/index.html')
